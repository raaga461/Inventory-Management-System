...
public class CreditNotePdf {
    ...
    public void execute(String ite, String invdate, String nw)   {
           ...
           String reportSource =realPath+"\\reports\\CreditNoteSalesPDF.jrxml";
             String reportDest = "D:\\SSI REPORTS\\CreditNoteSalesPDF.PDF";
            ...
            Desktop.getDesktop().open(new File("D:\\SSI REPORTS\\CreditNoteSalesPDF.PDF"));
