...
public class InvoiceSales {
 ...
 private     String realPath;
    ...
    public void execute(String ite, String invdate, String nw,int i)   {
           ...
           String reportSource =realPath+"\\reports\\SalesInvoicePDF.jrxml";
             String reportDest = "D:\\SSI REPORTS\\SalesInvoicePDF"+i+".PDF";
           ...
           params.put("nw",nw);
            ...
            Desktop.getDesktop().open(new File("E:\\SSI REPORTS\\SalesInvoicePDF"+i+".PDF"));
