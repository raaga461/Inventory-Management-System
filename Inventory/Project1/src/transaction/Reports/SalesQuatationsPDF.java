...
public class SalesQuatationsPDF {
    private Connection con;
    private ResultSet rs;
    private Statement st;
    private Logo ob; 
    public SalesQuatationsPDF() {
        super();
    }
    public void execute(String ite, String invdate, String nw)   {
           ...
           String reportSource =realPath+"\\reports\\QuoteSales.jrxml";
             String reportDest = "D:\\SSI REPORTS\\QuoteSales.PDF";
        ...
        ob=new Logo();
           ...
           System.out.println("params value is"+params);
            ...
            Desktop.getDesktop().open(new File("D:\\SSI REPORTS\\QuoteSales.PDF"));
