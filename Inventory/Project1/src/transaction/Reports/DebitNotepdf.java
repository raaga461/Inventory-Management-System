...
public class DebitNotepdf {
    ...
    public void execute(String ite, String invdate, String nw)   {
           ...
           String reportSource =realPath+"\\reports\\DebitNotePurchasesPDF.jrxml";
             String reportDest = "D:\\SSI REPORTS\\DebitNotePurchasesPDF.PDF";
              Map<String, Object> params =df.LogoMethod();
               params.put("ite",ite);
            ...
            Desktop.getDesktop().open(new File("D:\\SSI REPORTS\\DebitNotePurchasesPDF.PDF"));
