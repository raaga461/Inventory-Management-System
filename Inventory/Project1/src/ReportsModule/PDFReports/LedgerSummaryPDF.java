...
public class LedgerSummaryPDF {
    public LedgerSummaryPDF() {
        super();
    }
    
    public void execute( String fromdate, String todate,List<LedgerTableData>tdata,Double amt,Double amt1) {
       
        File f = new File(".");
        System.out.println("primt"+tdata);
        ServletContext ctx = (ServletContext)FacesContext.getCurrentInstance().getExternalContext().getContext();
        String realPath = ctx.getRealPath("/");
        String reportSource =realPath+"\\reports\\LedgerSummary.jrxml";
        ...
        String reportDest = "D:\\SSI REPORTS\\LedgerSumPDF.PDF";
        ...
        try {
            ...
            Desktop.getDesktop().open(new File("D:\\SSI REPORTS\\LedgerSumPDF.PDF"));
