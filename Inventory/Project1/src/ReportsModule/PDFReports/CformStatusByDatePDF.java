...
public class CformStatusByDatePDF {
    public CformStatusByDatePDF() {
        super();
    }
    public void execute( String fromdate, String todate,List<CformStatusByDateTableBean>tdata) {
        File f = new File(".");
        ServletContext ctx = (ServletContext)FacesContext.getCurrentInstance().getExternalContext().getContext();
        String realPath = ctx.getRealPath("/");
        String reportSource =realPath+"\\reports\\CformStatusByDate.jrxml";
        ...
        String reportDest = "D:\\SSI REPORTS\\CformStatusByDate.PDF";
        ...
        try {
            ...
            Desktop.getDesktop().open(new File("D:\\SSI REPORTS\\CformStatusByDate.PDF"));
