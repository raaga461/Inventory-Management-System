...
public class SalesItemPDF {
    public SalesItemPDF() {
        super();
    }
    public void execute(String ite, List<SalesItemTableBean>tdata) {
        File f = new File(".");
        ServletContext ctx = (ServletContext)FacesContext.getCurrentInstance().getExternalContext().getContext();
        String realPath = ctx.getRealPath("/");
        String reportSource =realPath+"\\reports\\ItemsSalesReportPDF.jrxml";
        ...
        String reportDest = "D:\\SSI REPORTS\\ItemsSalesReportPDF.PDF";
      ...
      params.put("ite", ite);
        try {
            ...
            Desktop.getDesktop().open(new File("D:\\SSI REPORTS\\ItemsSalesReportPDF.PDF"));
