...
public class CFormByCompanyPDF {
    public void execute(List<CFormByCompanyTableBean> tdata,Double amt) {
       
        File f = new File(".");
        System.out.println("primt"+tdata);
        ServletContext ctx = (ServletContext)FacesContext.getCurrentInstance().getExternalContext().getContext();
        String realPath = ctx.getRealPath("/");
        String reportSource =realPath+"\\reports\\CFormByCompanyPDF.jrxml";
        ...
        String reportDest = "D:\\SSI REPORTS\\CFormByCompanyPDF.PDF";
        ...
        try {
            ...
            Desktop.getDesktop().open(new File("D:\\SSI REPORTS\\CFormByCompanyPDF.PDF"));
