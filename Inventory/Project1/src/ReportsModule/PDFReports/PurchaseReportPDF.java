...
public class PurchaseReportPDF {
    public PurchaseReportPDF() {
        super();
    }
    public void execute(String fromdate, String todate, String ite, List<PurchaseReportTableBean>tdata,Double amt) throws JRException {
        File f = new File(".");
        ServletContext ctx = (ServletContext)FacesContext.getCurrentInstance().getExternalContext().getContext();
        String realPath = ctx.getRealPath("/");
        System.out.println("realpath ..........................."+realPath);
        String reportSource =realPath+"\\reports\\PurchaseDatesPDF.jrxml";
            //"C:\\Users\\USER\\AppData\\Roaming\\JDeveloper\\system11.1.2.4.39.64.36.1\\o.j2ee\\drs\\Application2\\Project1WebApp.war\\reports\\SalesDatesPDF.jrxml";
        //  String reportSource = "C:\\Users\\USER\\Documents\\NetBeansProjects\\SSI\\src\\PDFReports\\SalesDatesPDF.jrxml";
        String reportDest = "D:\\SSI REPORTS\\PurchaseDatesPDF.PDF";
        ...
        try {
            ...
            JasperPrint jasperPrint =
                JasperFillManager.fillReport(jasperReport, params,new JRBeanCollectionDataSource(tdata) );
            JasperExportManager.exportReportToPdfFile(jasperPrint, reportDest);
            Desktop.getDesktop().open(new File("D:\\SSI REPORTS\\PurchaseDatesPDF.PDF"));
