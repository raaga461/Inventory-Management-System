...
public class VoucherDatesPDF {
    public VoucherDatesPDF() {
        super();
    }
    public void execute(String fromdate, String todate, String ite, List<VoucherReportTableBean>tdata,Double amt) throws JRException {
        File f = new File(".");
        ServletContext ctx = (ServletContext)FacesContext.getCurrentInstance().getExternalContext().getContext();
        String realPath = ctx.getRealPath("/");
        System.out.println("realpath ..........................."+realPath);
        String reportSource =realPath+"\\reports\\VoucherDatesPDF.jrxml";
        ...
        String reportDest = "D:\\SSI REPORTS\\VoucherDatesPDF.PDF";
        ...
        try {
            ...
            Desktop.getDesktop().open(new File("D:\\SSI REPORTS\\VoucherDatesPDF.PDF"));
