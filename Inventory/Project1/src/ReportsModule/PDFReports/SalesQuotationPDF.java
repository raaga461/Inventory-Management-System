...
public class SalesQuotationPDF {
    public void execute(String fromdate, String todate, String ite,List<SalesQuotationTableBean> tdata,Double net) throws JRException {
        System.out.println();
        File f = new File(".");
        ServletContext ctx = (ServletContext)FacesContext.getCurrentInstance().getExternalContext().getContext();
        String realPath = ctx.getRealPath("/");
        System.out.println(realPath);
        String reportSource =realPath+"\\reports\\QuoteSalesPDF.jrxml";
        ...
        String reportDest = "D:\\SSI REPORTS\\SalesQuotPDF.PDF";
        ...
        try {
            ...
            Desktop.getDesktop().open(new File("D:\\SSI REPORTS\\SalesQuotPDF.PDF"));
