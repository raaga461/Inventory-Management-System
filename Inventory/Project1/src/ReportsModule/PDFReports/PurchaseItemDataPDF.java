...
public class PurchaseItemDataPDF {
    public PurchaseItemDataPDF() {
        super();
    }
    public void execute( List<PurchaseItemTableBean>tdata) {
        File f = new File(".");
        ServletContext ctx = (ServletContext)FacesContext.getCurrentInstance().getExternalContext().getContext();
        String realPath = ctx.getRealPath("/");
        String reportSource =realPath+"\\reports\\ItemPurchaseReportPDF.jrxml";
        ...
        String reportDest = "D:\\SSI REPORTS\\ItemPurchaseReportPDF.PDF";
        ...
        try {
            ...
            Desktop.getDesktop().open(new File("D:\\SSI REPORTS\\ItemPurchaseReportPDF.PDF"));
