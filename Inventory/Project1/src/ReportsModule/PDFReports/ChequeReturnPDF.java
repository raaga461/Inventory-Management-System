...
public class ChequeReturnPDF {
    
    public ChequeReturnPDF() {
        super();
    }
    public void execute( String fromdate, String todate,List<ChequeReturnsTableBean>tdata,Double amount) {
        File f = new File(".");
        ServletContext ctx = (ServletContext)FacesContext.getCurrentInstance().getExternalContext().getContext();
        String realPath = ctx.getRealPath("/");
        String reportSource =realPath+"\\reports\\ChqReturnsReportPDF.jrxml";
        ...
        String reportDest = "D:\\SSI REPORTS\\ChqReturnsReportPDF.PDF";
     ...
     params.put("amount",amount);
        ...
        try {
            ...
            Desktop.getDesktop().open(new File("D:\\SSI REPORTS\\ChqReturnsReportPDF.PDF"));
