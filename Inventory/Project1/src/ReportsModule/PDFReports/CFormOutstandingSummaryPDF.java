...
public class CFormOutstandingSummaryPDF {
    
    public void execute(List<CFormOutstandingSummaryTableBean> tdata) {
       
        File f = new File(".");
        System.out.println("primt"+tdata);
        ServletContext ctx = (ServletContext)FacesContext.getCurrentInstance().getExternalContext().getContext();
        String realPath = ctx.getRealPath("/");
        String reportSource =realPath+"\\reports\\CFormOutstandingSummaryPDF.jrxml";
        ...
        String reportDest = "D:\\SSI REPORTS\\CFormOutstandingSummaryPDF.PDF";
        ...
        try {
            ...
            Desktop.getDesktop().open(new File("D:\\SSI REPORTS\\CFormOutstandingSummaryPDF.PDF"));
