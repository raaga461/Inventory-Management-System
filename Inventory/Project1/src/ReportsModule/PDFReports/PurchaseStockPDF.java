...
public class PurchaseStockPDF {
    public void execute(List<PurchaseStockTableBean> tdata) {
       
        File f = new File(".");
        System.out.println("primt"+tdata);
        ServletContext ctx = (ServletContext)FacesContext.getCurrentInstance().getExternalContext().getContext();
        String realPath = ctx.getRealPath("/");
        String reportSource =realPath+"\\reports\\PurchaseStockPDF.jrxml";
        ...
        String reportDest = "D:\\SSI REPORTS\\PurchaseStockPDF.PDF";
        ...
        try {
            ...
            Desktop.getDesktop().open(new File("D:\\SSI REPORTS\\PurchaseStockPDF.PDF"));
