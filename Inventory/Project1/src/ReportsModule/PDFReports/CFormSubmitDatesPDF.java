...
public class CFormSubmitDatesPDF {
    
    public CFormSubmitDatesPDF() {
        super();
    }
    public void execute( String fromdate, String todate,List<CFormSubmitDatesTableBean>tdata) {
        File f = new File(".");
        ServletContext ctx = (ServletContext)FacesContext.getCurrentInstance().getExternalContext().getContext();
        String realPath = ctx.getRealPath("/");
        String reportSource =realPath+"\\reports\\CFSubmitDatesPDF.jrxml";
        ...
        String reportDest = "D:\\SSI REPORTS\\CFSubmitDatesPDF.PDF";
        ...
        try {
            ...
            Desktop.getDesktop().open(new File("D:\\SSI REPORTS\\CFSubmitDatesPDF.PDF"));
