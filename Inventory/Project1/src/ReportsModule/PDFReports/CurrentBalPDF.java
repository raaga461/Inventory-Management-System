...
public class CurrentBalPDF {
    public CurrentBalPDF() {
        super();
    }
    public void execute(String ite,List<CurrentBalanceTableBean>tdata,Double amount) {
        File f = new File(".");
        ServletContext ctx = (ServletContext)FacesContext.getCurrentInstance().getExternalContext().getContext();
        String realPath = ctx.getRealPath("/");
        String reportSource =realPath+"\\reports\\CurrentBalPDF.jrxml";
       //     "C:\\Users\\USER\\AppData\\Roaming\\JDeveloper\\system11.1.2.4.39.64.36.1\\o.j2ee\\drs\\Application2\\Project1WebApp.war\\reports\\SalesYealyPDF.jrxml";
        ...
        String reportDest = "D:\\SSI REPORTS\\CurrentBalPDF.PDF";
        ...
        try {
            ...
            Desktop.getDesktop().open(new File("D:\\SSI REPORTS\\CurrentBalPDF.PDF"));
