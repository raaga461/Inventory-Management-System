...
public class SalesCurrentStockPDF {
    
    public void execute(List<SalesCurrentStockTableBean> tdata) {
       
        File f = new File(".");
        System.out.println("primt"+tdata);
        ServletContext ctx = (ServletContext)FacesContext.getCurrentInstance().getExternalContext().getContext();
        String realPath = ctx.getRealPath("/");
        String reportSource =realPath+"\\reports\\StockSalesItemsCurrent.jrxml";
        ...
        String reportDest = "D:\\SSI REPORTS\\SalesItemsCurrentStock.PDF";
        ...
        try {
            ...
            Desktop.getDesktop().open(new File("D:\\SSI REPORTS\\SalesItemsCurrentStock.PDF"));
