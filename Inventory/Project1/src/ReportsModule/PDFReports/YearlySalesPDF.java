...
public class YearlySalesPDF {
    public YearlySalesPDF() {
        super();
    }
    public void execute( String fromdate, String todate,String ite,String party,List<YearlySalesTableBean>tdata,Double amount) {
        File f = new File(".");
        ServletContext ctx = (ServletContext)FacesContext.getCurrentInstance().getExternalContext().getContext();
        String realPath = ctx.getRealPath("/");
        String reportSource =
            realPath+"\\reports\\SalesYealyPDF.jrxml";
        //  String reportSource = "C:\\Users\\USER\\Documents\\NetBeansProjects\\SSI\\src\\PDFReports\\SalesDatesPDF.jrxml";
        String reportDest = "D:\\SSI REPORTS\\SalesYealyPDF.PDF";
        ...
        try {
            ...
            Desktop.getDesktop().open(new File("D:\\SSI REPORTS\\SalesYealyPDF.PDF"));
