...
public class PurchaseItemStockPDF {
    public void execute(List<PurchaseItemStockTableBean> tdata) {
       
        File f = new File(".");
        System.out.println("primt"+tdata);
        ServletContext ctx = (ServletContext)FacesContext.getCurrentInstance().getExternalContext().getContext();
        String realPath = ctx.getRealPath("/");
        String reportSource =realPath+"\\reports\\PurchaseItemStockPDF.jrxml";
        ...
        String reportDest = "D:\\SSI REPORTS\\PurchaseItemStockPDF.PDF";
        ...
        try {
            ...
            Desktop.getDesktop().open(new File("D:\\SSI REPORTS\\PurchaseItemStockPDF.PDF"));
