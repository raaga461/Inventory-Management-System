...
public class AccountGroupPDF {
    public AccountGroupPDF() {
        super();
    }
    public void execute( List<AccountGroupTableBean>tdata) {
        File f = new File(".");
        ServletContext ctx = (ServletContext)FacesContext.getCurrentInstance().getExternalContext().getContext();
        String realPath = ctx.getRealPath("/");
        String reportSource =realPath+"\\reports\\AccountsGroupReportPDF.jrxml";
        ...
        String reportDest = "D:\\SSI REPORTS\\AccountsGroupReportPDF.PDF";
        ...
        try {
            ...
            Desktop.getDesktop().open(new File("D:\\SSI REPORTS\\AccountsGroupReportPDF.PDF"));
