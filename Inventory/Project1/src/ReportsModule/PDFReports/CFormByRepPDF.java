...
public class CFormByRepPDF {
    
    public void execute(List<CFormByRepTableBean> tdata,Double amt) {
       
        File f = new File(".");
        System.out.println("primt"+tdata);
        ServletContext ctx = (ServletContext)FacesContext.getCurrentInstance().getExternalContext().getContext();
        String realPath = ctx.getRealPath("/");
        String reportSource =realPath+"\\reports\\CFormByRepPDF.jrxml";
        ...
        String reportDest = "D:\\SSI REPORTS\\CFormByRepPDF.PDF";
        ...
        try {
            ...
            Desktop.getDesktop().open(new File("D:\\SSI REPORTS\\CFormByRepPDF.PDF"));
